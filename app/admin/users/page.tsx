    ...
    <div>
          ...
          <TableBody>
            {isLoading ? (
              ...
              data?.users?.map((userSettings: any) => {
                const userId = String(userSettings.user_id || userSettings.userId || "");
                const role = String(userSettings.role || "user");
                const dailyLimit = Number(userSettings.daily_limit || userSettings.dailyLimit || 0);
                const createdAt = String(userSettings.created_at || userSettings.createdAt || "");
                return (
                  <TableRow key={userId}>
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-sm">{userId.slice(0, 8)}...</div>
                    ...
                    <TableCell>
                      <Select
                        value={role}
                        onValueChange={(value) => handleRoleChange(userId, value as "user" | "admin")}
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1 text-sm">
                        ...
                        <span className="text-muted-foreground">{dailyLimit} μg/day</span>
                      </div>
                    </TableCell>
                    <TableCell>
      ...
      <div className="lg:hidden space-y-3">
        {isLoading ? (
          ...
          <div className="text-center py-8 text-sm">No users found</div>
        ) : (
          data?.users?.map((userSettings: any) => {
            const userId = String(userSettings.user_id || userSettings.userId || "");
            const role = String(userSettings.role || "user");
            ...
            const createdAt = String(userSettings.created_at || userSettings.createdAt || "");
            return (
              <div key={userId} className="bg-white border rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="admin">
                          <div className="flex items-center gap-2"><Shield className="w-3 h-3" /> Admin</div>
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="flex justify-between items-center pt-2 border-t">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      toast({ title: "User Details", description: "User details view coming soon" });
                    }}
                  >
                    View Details
                  </Button>
