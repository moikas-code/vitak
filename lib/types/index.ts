...
export const food_schema = z.object({
  ...
  usda_description: z.string().nullable().optional(),
  usda_category: z.string().nullable().optional(),
  usda_derivation_code: z.string().nullable().optional(),
  last_usda_sync: z.string().nullable().optional(),
  usda_data_hash: z.string().nullable().optional(),
  created_at: z.date(),
  updated_at: z.date(),
});
